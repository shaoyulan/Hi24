    ...
    <!-- Page/Breadcrumbs 麵包屑 (路徑)-->
        <div class="row">
            <div class="col-lg-12">             
                <ol class="breadcrumb">
                    ...
                    <li><a href="product_paging.html">上身類</a></li>
                    <li class="active">棉質編織圓領毛衣-女</li>
                </ol>
            </div>
        </div>
        <!-- /.row -->
      ...
      <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <p class="p_price_color right">
                  <span>NT$</span> <span class="p_price_money">490</span>
                </p>
                <p class="p_price_activity right">冬日煥新．限時搶購 
              ...
              <div>
                <a href="#"  class="p_size">M</a>
              </div>
              <div>
                <a href="#"  class="p_size">L</a>
              </div>
              <div><a href="#"  class="p_size">XL</a>
              </div>
              <div>
                <a href="#"  class="p_size">XXL</a>
              </div>
              <p class="clear"></p>
              <p class="right"><a href="productdesc_w.htm"><i class="fa fa-files-o"></i> 產品說明與尺寸表</a>　 <a href="#"><i class="fa fa-heart"></i> 收藏商品</a></p>
     ...
     <div class="row">
          ...
          <div class="col-md-8 img-portfolio right">
              <p>
                 <img class="img-responsive" src="../images/women/sweater/sw001a-1.jpg" width="760" height="910" alt=""/>
              </p>
              <p>
                 <img class="img-responsive" src="../images/women/sweater/sw001a-2.jpg" width="760" height="910" alt=""/>
              </p>
              <p>
                  <img class="img-responsive" src="../images/women/sweater/sw001a-3.jpg" width="760" height="910" alt=""/>
              </p>
              <p>
                <img class="img-responsive" src="../images/women/sweater/sw001a-4.jpg" width="760" height="910" alt=""/>
              </p>
          </div>
