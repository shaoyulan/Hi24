        ...
        <!-- Page/Breadcrumbs 麵包屑 (路徑)-->
            ...
            <div class="login-tab">
              ...
              <div id="myTabContent" class="tab-content">
                ...
                <form>
                <div class="login_register">            
                <h3 align="center">設定登入密碼</h3>
                <p>設定6-20碼英數字密碼</p>
                <p align="center"><img src="../images/member/register03.jpg" width="267" height="46" alt=""/></p>
    <p></p>
                  <p>
                   <label for="login_pw" class="login_pw">請輸入(6-20碼英數字)</label>
                    <input type="text" value="" size="32">
                  </p>
