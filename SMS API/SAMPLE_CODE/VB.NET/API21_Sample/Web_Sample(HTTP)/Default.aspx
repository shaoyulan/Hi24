<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Default.aspx.vb" Inherits="Web_Sample_HTTP_._Default" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>EVERY8D SMS API2.1 ASP.NET Sample (HTTP)</title>
	<style type="text/css">
		#subjectInputText
		{
			width: 617px;
...
<body>
    ...
    <h2>EVERY8D SMS API2.1 ASP.NET Sample (HTTP)</h2>
    <div>
