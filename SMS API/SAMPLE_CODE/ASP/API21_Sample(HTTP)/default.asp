<!-- #INCLUDE virtual="/SMSHttp.asp" -->
<html>
<head>
	<title>EVERY8D SMS API2.1 ASP Sample (HTTP)</title>
...
<%
	...
	content = "API2.1 test  ASP Sample HTTP"	'簡訊內容
	...
	'取餘額
	If sms.getCredit(userID, password) Then
		'取得餘額成功
	...
	'傳送簡訊
	If sms.sendSMS(userID, password, subject, content, phones, sendTime) Then
		'傳送簡訊成功
